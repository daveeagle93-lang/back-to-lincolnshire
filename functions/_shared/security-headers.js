...
//
// CSP notes:
// - script-src/style-src are 'self' only: Leaflet's JS/CSS are self-hosted
//   under /vendor/leaflet/ (app.js, sw.js APP_SHELL_URLS).
...
const CSP =
  "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://*.tile.openstreetmap.org; connect-src 'self'; worker-src 'self'; manifest-src 'self'; base-uri 'none'; frame-ancestors 'none';";
